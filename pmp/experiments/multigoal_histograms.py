...
def generate_winner_files(current_dir, m, n, k, multigoal_rule, rule1, rule2, r1_percentage, r2_percentage, distribution, reps):
    for repetition in range(1, reps + 1):

        out_filename = '{}_{}_{}_k{}-{}.win'.format(multigoal_rule.__name__, r1_percentage, r2_percentage, k, repetition)
        tmp_filename = 'tmp'
        ...
        rule = multigoal_rule(s1=rule1_threshold, s2=rule2_threshold, log_errors=True)
