...
from pmp.multigoal.pareto import draw_transition_from_winner_files
...
generate_winner_files_for_pareto(dir_name, configs, multigoal_rule, k, start=start, step=step, save_win=True)
draw_transition_from_winner_files(dir_name, m, n, k, multigoal_rule, distribution, repetitions)
